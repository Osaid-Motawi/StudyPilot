...
// Shared Pomodoro logic for BOTH designs. Fully client-side — today's completed
// focus-session count lives in localStorage keyed by date so it resets daily.
export const BUILTIN_MODES = {
  focus: { label: 'Focus', minutes: 25 },
  short_break: { label: 'Short break', minutes: 5 },
  long_break: { label: 'Long break', minutes: 15 },
};
export const MODE_ORDER = ['focus', 'short_break', 'long_break', 'custom'];
